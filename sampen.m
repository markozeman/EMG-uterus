...
% the Physionet implementation is used with parameters sampen(sig, m+1, r, 1, 0, 0).
% It will return a vector of sample entropies with maximum template lengths of m. 
